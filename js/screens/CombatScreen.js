...
export function setupCombatScreen(game) {
    ...
    console.log('[CombatScreen] Setting up combat screen v0.2.8');
    ...
    function applyCardEffects(card, targetIndex) {
        ...
        if (card.damage && card.damage > 0) {
            if (targetIndex !== null && targetIndex >= 0 && enemies[targetIndex]) {
                ...
                console.log(`[CombatScreen] Dealt ${damage + blocked} damage to ${enemies[targetIndex].name} (${blocked} blocked)`);
    ...
    function endTurn() {
        ...
        // Reset player block at start of enemy turn
        game.state.set('combat.block', 0);
    ...
    function enemyTurn() {
        ...
        enemies.forEach((enemy, i) => {
            ...
            if (enemy.intent.type === 'attack') {
                ...
                playerHp -= damage;
                console.log(`[CombatScreen] ${enemy.name} attacks for ${damage + blocked} (${blocked} blocked)`);
