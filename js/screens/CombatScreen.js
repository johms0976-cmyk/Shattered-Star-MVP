...
export function setupCombatScreen(game) {
    ...
    // ── BiomeEffects + CorruptionCurrency ──
    ...
    try {
        ...
        console.log('[CombatScreen] BiomeEffects + CorruptionCurrency initialized');
    } catch (e) {
        console.warn('[CombatScreen] Failed to init BiomeEffects/CorruptionCurrency:', e);
    }
    ...
    function renderEnemies() {
        ...
        container.innerHTML = enemies.map((enemy, i) => {
            ...
            return `
                <div class="enemy enemy-${enemyType}" data-index="${i}" data-enemy-id="${enemy.id || enemy.instanceId || i}">
