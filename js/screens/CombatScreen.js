...
export function setupCombatScreen(game) {
    ...
    function renderHand() {
        const container = document.getElementById('hand-container') || document.getElementById('hand');
        if (!container) {
    ...
    function renderPileCounters() {
        ...
        const drawCounter = document.getElementById('draw-pile-count');
        const discardCounter = document.getElementById('discard-pile-count');
