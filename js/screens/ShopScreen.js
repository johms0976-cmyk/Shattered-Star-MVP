...
export function setupShopScreen(game) {
    ...
    function generateShop() {
        const heroId = game.state.get('heroId') || game.state.get('hero.id') || game.state.get('hero') || 'korvax';
        activeTab = 'standard';
    ...
    function handleVoidPurchase(type, index) {
        ...
        } else if (type === 'void-fragment') {
            result = voidMerchant.purchaseFragment(index);
        }
